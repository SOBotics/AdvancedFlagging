 ...
 */
        ...
        /***/ ((__unused_webpack_module, exports, __webpack_require__) => {
            ...
            function getCommentText({ opReputation, opName }, { comments }) {
                ...
                let comment = (comments === null || comments === void 0 ? void 0 : comments[commentType]) || (comments === null || comments === void 0 ? void 0 : comments.low);
                if (comment){
        ...
        function getReportLinks(reporters, post) {
            ...
            shared_1.cachedFlagTypes
                ...
                const showOnSo = ['Red flags', 'General', 'Answer-related'].includes(belongsTo) || shared_1.isStackOverflow;
